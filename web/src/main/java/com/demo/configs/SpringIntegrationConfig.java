...
public class SpringIntegrationConfig {
     ...
     */
    @Bean
    public MessageHandler rabbitOutboundEndpoint(AmqpTemplate amqpTemplate) {
     ...
     *
     * @param sourceChannel Input channel.
     * @param messageHandler Message handler.
     * @return An {@link EventDrivenConsumer}.
     */
    @Bean
    public EventDrivenConsumer rabbitConsumer(@Qualifier("toRabbit") SubscribableChannel sourceChannel,
                                              @Qualifier("rabbitOutboundEndpoint") MessageHandler messageHandler) {
        return new EventDrivenConsumer(sourceChannel, messageHandler);
    }
}
